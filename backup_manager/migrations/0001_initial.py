    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('password', django_cryptography.fields.encrypt(models.CharField(blank=True, help_text='Overwrite the password of user used in periodic tasks', max_length=255, null=True))),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('password', django_cryptography.fields.encrypt(models.CharField(blank=True, help_text='Password of user used in periodic tasks', max_length=255, null=True))),
            ],
            options={
                'db_table': 'tb_host',
            },
